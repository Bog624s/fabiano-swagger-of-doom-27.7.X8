            ...
            switch (s.State)
            {
                ...
                case F.Acquired:
                    ...
                    else if (vect.Length > 1)
                    {
                        ...
                        if (vect.Length > 2)
                            dist = host.GetSpeed(0.5f + ((float)player.Stats[4] / 100)) * (time.ElaspedMsDelta / 1000f);
                        else if(vect.Length > 3.5)
                            dist = host.GetSpeed(0.5f + (player.Stats[4] + (float)player.Boost[4] / 100)) * (time.ElaspedMsDelta / 1000f);
                        else if (vect.Length > 5)
                            dist = host.GetSpeed(1.0f + (player.Stats[4] + (float)player.Boost[4] / 100)) * (time.ElaspedMsDelta / 1000f);
                        else if (vect.Length > 6)
                            dist = host.GetSpeed(1.35f + (player.Stats[4] + (float)player.Boost[4] / 100)) * (time.ElaspedMsDelta / 1000f);
                        else if (vect.Length > 7)
                            dist = host.GetSpeed(1.5f + (player.Stats[4] + (float)player.Boost[4] / 100)) * (time.ElaspedMsDelta / 1000f);
                        else if (vect.Length > 10)
                            dist = host.GetSpeed(2f + (player.Stats[4] + (float)player.Boost[4] / 100)) * (time.ElaspedMsDelta / 1000f);
