...
namespace wServer.realm
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger(nameof(Oryx));
        ...
        public void Init()
        {
            ...
            foreach (KeyValuePair<WmapTerrain, Tuple<int, Tuple<string, double>[]>> i in spawn)
            {
        ...
        private void EnsurePopulation()
        {
            ...
            foreach (KeyValuePair<int, Enemy> i in world.Enemies)    //Kill
            {
